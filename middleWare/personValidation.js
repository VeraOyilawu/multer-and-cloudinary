...
const validateProfile = (req, res, next) => {
    const schema = Joi.object({
        ...
        personNumber: Joi.string().pattern(/^[0-9]{10}$/).required(),
...
// Validate 2...... another way of validating 
...
// const { schema } = require("../models/personModel")

// const personValidation = (req, res, next) => {
//     const Schema = Joi.object({
//         personName: Joi.string().required(),
//         personNumber: Joi.string().pattern(/^[0-9]{11}$/).required(),
//         personProfile: Joi.string().required()
//     })
